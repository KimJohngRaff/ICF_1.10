...
public class Block_ICF_Metal extends Block implements IMetaBlockName {
	
	private final int maxMeta;
	private static String[] values;
	
	public Block_ICF_Metal(String unlocalizedName, Material material, String[] names, float hardness, float resistance, String registryName){
		super(material);
	...
	private static final PropertyEnum TYPE = PropertyEnum.create("type", Block_ICF_Metal.EnumType.class);
	...
	private enum EnumType implements IStringSerializable {
	    ...
	    private EnumType(int ID) {
	        this.ID = ID;
	        this.name = ICF_Blocks.icfMetalBlock_names[ID];
	    }
