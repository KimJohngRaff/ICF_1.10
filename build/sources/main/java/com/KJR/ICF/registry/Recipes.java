...
public class Recipes {
	...
	public static void init() {
		...
		GameRegistry.addSmelting(new ItemStack(ICF_Items.icfDust_Metal, 1, 10), new ItemStack(Items.IRON_INGOT, 1, 0), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ICF_Items.icfDust_Metal, 1, 11), new ItemStack(Items.GOLD_INGOT, 1, 0), 1.0F);
		...
		//Cactus
		for (int j = 0; j < ICF_Blocks.icfBlock_names.length; j++) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ICF_Blocks.compressedCactus, 8, j), "iii", "idi", "iii", 'i', new ItemStack(ICF_Blocks.icfBlock, 1, x), 'd', colors[j]));
		}
		GameRegistry.addShapedRecipe(new ItemStack(ICF_Blocks.compressedCactus, 1, 2), "iii", "iii", "iii", 'i', Blocks.CACTUS);
		GameRegistry.addShapedRecipe(new ItemStack(ICF_Items.icfSingleStack, 1, 0), "iii", "ibi", "iii", 'i', new ItemStack(ICF_Blocks.compressedCactus, 1, x), 'b', Items.BOOK);
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ICF_Items.toolCactusKnife, 1, 0), "cic", "cic", " s ", 'i', "ingotNickel", 'c', Blocks.CACTUS, 's', Items.STICK));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ICF_Items.toolHeavyCactusKnife, 1, 0), "cic", "cic", " s ", 'i', "ingotPlatinum", 'c', new ItemStack(ICF_Blocks.compressedCactus, 1, x), 's', Items.BLAZE_ROD));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ICF_Blocks.icfMetalBlock, 1, 10), "iii", "iii", "iii", 'i', new ItemStack(ICF_Items.icfMisc_1, 1, 6)));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ICF_Items.silver_knife, 1, 0), " i", "s ", 's', new ItemStack(Items.STICK), 'i', "ingotSilver"));
		
		//dust mixing
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ICF_Items.icfDust_Metal, 4, 6), "dustCopper", "dustCopper", "dustCopper", "dustTin"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ICF_Items.icfDust_Other, 1, 11), "ses", "oeo", "pep", 's', "dustEmerald", 'e', "dustEndimandium", 'o', "dustObsidian", 'p', "dustPlatinum"));
