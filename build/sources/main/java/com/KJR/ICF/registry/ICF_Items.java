...
import com.KJR.ICF.items.Item_ICF_Single_Stack;
...
public class ICF_Items {
	...
	public static Item icfSingleStack;
	...
	public static void initItems() {
		...
		GameRegistry.register(icfSingleStack = new Item_ICF_Single_Stack());
		//tools
		...
		//food
		GameRegistry.register(cheese_wheel = new Item_ICF_Food("cheese_wheel", 7, 1.4F, false, "cheese_wheel"));
		GameRegistry.register(cheese_sandwich = new Item_ICF_Food("cheese_sandwich", 10, 2.4F, false, "cheese_sandwich"));
		GameRegistry.register(pork_back = new Item_ICF_Food("pork_back", 4, 1.2F, false, "pork_back"));
		GameRegistry.register(slice_of_cheese = new Item_ICF_Food("slice_of_cheese", 4, 1.0F, false, "slice_of_cheese"));
		GameRegistry.register(slice_of_bread = new Item_ICF_Food("slice_of_bread", 3, 0.6F, false, "slice_of_bread"));
		GameRegistry.register(slice_of_raw_bacon = new Item_ICF_Food("slice_of_raw_bacon", 2, 1.2F, false, "slice_of_raw_bacon"));
		GameRegistry.register(slice_of_cooked_bacon = new Item_ICF_Food("slice_of_cooked_bacon", 5, 1.6F, false, "slice_of_cooked_bacon"));
		GameRegistry.register(fried_egg = new Item_ICF_Food("fried_egg", 6, 1.2F, false, "fried_egg"));
		GameRegistry.register(bacon_egg_cheese = new Item_ICF_Food("bacon_egg_cheese", 14, 3.6F, false, "bacon_egg_cheese"));
		//armor
	...
	public static void registerItemVariants() {
		...
		for (int i = 0; i < Item_ICF_Single_Stack.names.length; i++) {
			ModelBakery.registerItemVariants(icfSingleStack, new ModelResourceLocation(ICF_Global.modID + ":item" + Item_ICF_Single_Stack.names[i], "inventory"));
		}
		//tools
		...
		ModelBakery.registerItemVariants(toolCactusKnife, new ModelResourceLocation(ICF_Global.modID + ":CactusKnife", "inventory"));
		ModelBakery.registerItemVariants(toolHeavyCactusKnife, new ModelResourceLocation(ICF_Global.modID + ":HeavyCactusKnife", "inventory"));
		//durable
	...
	public static void renderItems() {
		...
		for (int i = 0; i < Item_ICF_Single_Stack.names.length; i++) {
			registerRenders(icfSingleStack, i, "item" + Item_ICF_Single_Stack.names[i]);
		}
		//tools
