...
public class Item_ICF_Dust_Other extends Item {
    ...
    public static String[] names = {"diamond", "emerald", "lapis", "coal", "obsidian", "saltpeter", "sulfur", "netherQuartz", "granite", "dorite", "andesite", "replication"};
