...
public class ICF_WorldGenMinable extends WorldGenerator
{
    ...
    public ICF_WorldGenMinable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.STONE));
    }

    public ICF_WorldGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
