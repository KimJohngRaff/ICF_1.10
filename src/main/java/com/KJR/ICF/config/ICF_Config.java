package com.KJR.ICF.config;
	...
	public class ICF_Config {
		...
		private static void syncConfig(boolean loadFromConfigFile, boolean readFieldsFromConfig) {
			...
			propertyGenerateSilver.setComment(I18n.format("gui.config.gen.silver.comment"));
			...
			propertyGenerateAluminum.setComment(I18n.format("gui.config.gen.aluminum.comment"));
			...
			propertyGenerateNickel.setComment(I18n.format("gui.config.gen.nickel.comment"));
			...
			propertyGenerateSulfur.setComment(I18n.format("gui.config.gen.sulfur.comment"));
			...
			propertyGenerateSaltpeter.setComment(I18n.format("gui.config.gen.saltpeter.comment"));
